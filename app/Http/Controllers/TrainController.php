...
class TrainController extends Controller
{
    ...
    public function popolaDB() {
        $data = [
            ...
            'late' => ['no','10 min di ritardo','5 min di ritardo','62 min di ritardo','46 min di ritardo','74 min di ritardo','14 min di ritardo','90 min di ritardo','30 min di ritardo']
        ];
        $train = new Train();
        ...
        $train->codice_treno = $data['late'][rand(0, 8)];
        dd($train);
        $train->save();
        return view('trains', compact('trains'));
    }
