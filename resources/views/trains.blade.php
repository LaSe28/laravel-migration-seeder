    ...
    <div class="trains">
        @foreach ($trains as $train)
            <div class="{{$train->id %2 == 0 ? 'even' :''}}">
                ...
                <p>Partenza: {{$train->stazione_partenza}}, binario {{$train->binario}}. Partenza programmata alle {{date('H:i:s', strtotime($train->orario_partenza))}} del {{date('d M y', strtotime($train->orario_partenza))}} </p>
